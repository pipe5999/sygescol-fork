...
function Banco({ cga, escala, colegio, setShow, setCont, contador1 }: Props) {
  ...
  const getData = async () => {
    axios
      .get(
        `/api/ObservacionesProcesos/Banco/BaseInfo?c=${colegio}&cg=${cga}&e=${escala}`
      )
      .then((res: any) => {
          ...
          <div className="relative   py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400 ">
            <div className="container mx-auto text-center px-4 mb-4">
              <div className="flex flex-row justify-around items-center uppercase text-center font-bold lg:text-2xl py-4 px-4 bg-blue-800 text-white rounded-lg">
                Banco de Observaciones para los Descriptores
                <button
                  onClick={handleClick}
              ...
              {showModal && (
                <div className="modal-overlay">
                  <div className="modal">
                    ...
                    <div className="flex flex-row items-center gap-2 my-3">
                      <p className="text-lg font-medium">Observación:</p>
                      <textarea
