                ...
                <div className=" h-full container m-auto col-span-7  w-full flex-col bg-[url('/fondoWelcome.webp')] bg-cover bg-no-repeat flex items-center justify-center p-5 ">
                    <div className="bg-[#070E54]/90 text-white rounded-[1rem] shadow-xl py-5 px-5 w-full lg:w-10/12 xl:w-3/4">
                        <div className="grid lg:grid-cols-3 lg:gap-4 p-4 -mx-3 items-center">
                            ...
                            >
                                <span className='text-center text-3xl font-bold'>{datosColegio?.nombreInst}</span>

                            </div>
                            <div className='justify-center flex'>
                                <Image
                                    src={datosColegio?.urlColegio && `${datosColegio?.urlColegio}sygescol${year.getFullYear()}/images/escudo.gif` || ""}
                                    alt="Escudo Col"
                                    width={150}
                                    height={150}
                                />
                            ...
                            <div className='justify-center flex'>
                                <Image
                                    src={datosColegio?.urlColegio && `${datosColegio?.urlColegio}sygescol${year.getFullYear()}/images/ivhorsnet.gif` || ""}
                                    alt="Escudo Col"
                                    width={200}
                                    height={200}
                                />
