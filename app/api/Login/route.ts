...
export async function GET(req: any) {
    ...
    try {
        ...
        const [dimensiones]: any = await conexion.query(`SELECT aintrs.i AS idAsig, aintrs.b AS nombreAsigna, cga.i AS CgaId FROM cga INNER JOIN aintrs ON cga.a = aintrs.i WHERE cga.g = ${docente}`)
