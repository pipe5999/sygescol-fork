...
export async function GET(req:any){
    ...
    try {
        ...
        const [save]:any = await conexion.query(`INSERT INTO newProcesosEvaluacion(grado,grupo,periodo,escala,relacionBanco,cga) VALUES('${periodo[0]?.grado_base}','${periodo[0]?.grupo_id}','${periodo[0]?.per_id}','${escala}','${id}','${cga}')`)
