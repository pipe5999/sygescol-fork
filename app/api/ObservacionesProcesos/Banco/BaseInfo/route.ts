...
export async function GET(req: any){
    ...
    try {
        ...
        const [banco]:any = await conexion.query(`SELECT * FROM newBancoObservacionesProcesos WHERE cga = ${cga} AND escala = ${escala}`)
        console.log(`SELECT * FROM newBancoObservacionesProcesos WHERE cga = ${cga} AND escala = ${escala}`)
